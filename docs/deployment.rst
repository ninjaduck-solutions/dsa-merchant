...
First install the ``dsa_merchant`` package. It is very useful
...
::
    ...
    $ pip install dsa_merchant[mailgun]
...
::
    ...
    $ pip install dsa_merchant[raven]
...
::
    ...
    $ echo "dsa_merchant.config.settings.public" > envs/prod/DJANGO_SETTINGS_MODULE
