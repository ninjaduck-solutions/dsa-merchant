...
These are the default settings in :file:`dsa-merchant/manage.py`.
...
.. list-table::
    ...
    * - ``DJANGO_SETTINGS_MODULE``
      - ``'dsa_merchant.config.settings.dev'``
      - ``DJANGO_SETTINGS_MODULE``
...
:py:class:`dsa_merchant.config.settings.common.Common`.
...
.. list-table::
    ...
    * - ``MIDDLEWARE_CLASSES``
      ...
      - | A list of middleware classes to
        | use.
    * - ``MEDIA_ROOT``
      - ``'<full path to dsa_merchant>/media/'``
      - ``DJANGO_MEDIA_ROOT``
    ...
    * - ``STATIC_ROOT``
      - ``'<full path to dsa_merchant>/static_root/'``
      - ``DJANGO_STATIC_ROOT``
...
:py:class:`dsa_merchant.config.settings.databases.Databases`.

The following classes inherit from it:

* :py:class:`dsa_merchant.config.settings.dev.Development`
* :py:class:`dsa_merchant.config.settings.public.Production`
* :py:class:`dsa_merchant.config.settings.public.Staging`
* :py:class:`dsa_merchant.config.settings.test.Testing`
...
:py:class:`dsa_merchant.config.settings.email.SMTP`
...
from :py:class:`dsa_merchant.config.settings.email.Mailgun`
to use these settings.
...
from :py:class:`dsa_merchant.config.settings.public.Raven`
to use these settings.
...
The class
:py:class:`dsa_merchant.config.settings.public.Public`
...
from :py:class:`dsa_merchant.config.settings.public.SSL`
to use these settings.
:py:class:`dsa_merchant.config.settings.public.Production`
