...
class Common(Configuration):
    ...
    ADMINS = AdminsValue(
        (('ninjaduck.solutions', 'contact@ninjaduck.solutions'),)
    )
    MANAGERS = ADMINS
    ...
    ROOT_URLCONF = 'dsa_merchant.config.urls'

    WSGI_APPLICATION = 'dsa_merchant.config.wsgi.application'
    ...
    TEMPLATES = [
        {
            ...
            'OPTIONS': {
                'context_processors': [
                    ...
                    'dsa_merchant.context_processors.django_version',
                ],
    ...
    GRAPPELLI_ADMIN_TITLE = 'DSA-Händler Admin'

    EMAIL_SUBJECT_PREFIX = '[DSA-Händler]'

    DEFAULT_FROM_EMAIL = values.EmailValue('contact@ninjaduck.solutions')
